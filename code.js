...
function renderColorInput(wrap, variable, modeId, value) {
  ...
  function commit() {
    ...
    send({ type: 'SET_OVERRIDE', variableId: variable.id, modeId, value: { ...rgb, a: alpha } });
  }
...
function renderFloatInput(wrap, variable, modeId, value) {
  ...
  input.addEventListener('change', () => {
    send({ type: 'SET_OVERRIDE', variableId: variable.id, modeId, value: parseFloat(input.value) });
  });
...
function renderStringInput(wrap, variable, modeId, value) {
  ...
  input.addEventListener('change', () => {
    send({ type: 'SET_OVERRIDE', variableId: variable.id, modeId, value: input.value });
  });
  wrap.appendChild(input);
}
...
function renderBoolInput(wrap, variable, modeId, value) {
  ...
  input.addEventListener('change', () => {
    send({ type: 'SET_OVERRIDE', variableId: variable.id, modeId, value: input.checked });
  });
  wrap.appendChild(input);
}
